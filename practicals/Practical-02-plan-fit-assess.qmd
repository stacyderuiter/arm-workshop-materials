---
title: "Practical 2: Plan, Fit, Assess your UPF Model (Part 2)"
author: 
...
You will make additions and modifications to your previous Quarto file to get an improved and expanded version.

# Tasks

## 1. (Re)-Planning a Model

Keep the same response variable you began with last time.
...
-   Consider making a causal diagram and/or using a [model planning checklist](https://stacyderuiter.github.io/stat245-fa24/model-plan-checklist.pdf) to identify any other variable that are confounders, colliders, moderators, or in mediation chains relative to your main key predictor. Based on your results, decide which predictors should be included in your model. 
