...
There is some error $\epsilon$ in our model for the data, so we should keep track of it. We could say
...
---
## OR Complete Regression Equation
### Connecting the Normal distribution parameter $\mu$
