...
$$log(\lambda_i) = \beta_0 + \beta_1 x_{1,i} + \beta_2 x_{2,i} + \beta_3 x_{3,i} +$$
$$...\beta_k x_{k,i} + \epsilon_{i}$$
...
$$
P(x = s \vert n, p) = {n \choose s}p^k(1-p)^{(n-k)}
$$
--
...
$$\beta_0 + \beta_1 x_{1,i} + \beta_2 x_{2,i} + \beta_3 x_{3,i} + ...\beta_k x_{k,i} + \epsilon_{i}$$

Where: $\text{response} \sim Binom(n, p_i)$
